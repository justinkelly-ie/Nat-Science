...
| **Layer 2a** | **`Idris2-Multiset-Binary`** | `Idris2-Multiset-Binary` | Modulo-2 binary logic ($\mathbb{F}_2$), Mobius transforms, circuit resolution | [justinkelly-ie/Idris2-Multiset-Binary](https://github.com/justinkelly-ie/Idris2-Multiset-Binary) |
| **Layer 2b** | **`Idris2-Multiset-Ternary`** | `Idris2-Multiset-Ternary` | Balanced ternary geometry ($\mathbb{F}_3$), Narayana combinatorial polynomials | [justinkelly-ie/Idris2-Multiset-Ternary](https://github.com/justinkelly-ie/Idris2-Multiset-Ternary) |
